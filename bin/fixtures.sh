...
jedis="Jedi"
"$ROOT/backlog" b:team:add "$empire"
"$ROOT/backlog" b:team:add "$rebelAlliance"
"$ROOT/backlog" b:team:add "$siths"
"$ROOT/backlog" b:team:add "$criminals"
"$ROOT/backlog" b:team:add "$jedis"
...
"$ROOT/backlog" b:sprint:add "$episodeOne" "$rebelAlliance" "$oldRepublic"
"$ROOT/backlog" b:sprint:add "$episodeTwo" "$rebelAlliance" "$oldRepublic"
"$ROOT/backlog" b:sprint:add "$episodeThree" "$rebelAlliance" "$oldRepublic"
"$ROOT/backlog" b:sprint:add "$episodeOne" "$rebelAlliance" "$newOrder"
"$ROOT/backlog" b:sprint:add "$episodeTwo" "$rebelAlliance" "$newOrder"
"$ROOT/backlog" b:sprint:add "$episodeThree" "$rebelAlliance" "$newOrder"
"$ROOT/backlog" b:sprint:add "$rogueOne" "$rebelAlliance" "$standalone"
"$ROOT/backlog" b:sprint:add "$hanSoloStory" "$rebelAlliance" "$standalone"
"$ROOT/backlog" b:sprint:add "$episodeSeven" "$rebelAlliance" "$firstOrder"
"$ROOT/backlog" b:sprint:add "$episodeEight" "$rebelAlliance" "$firstOrder"
