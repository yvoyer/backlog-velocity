...
# Old republic
"$ROOT/backlog" b:sprint:join "Episode 1" "Anakin Skywalker" 9 "$oldRepublic"
"$ROOT/backlog" b:sprint:join "Episode 1" "Mace Windu" 4 "$oldRepublic"
"$ROOT/backlog" b:sprint:join "Episode 1" "Yoda" 5 "$oldRepublic"
"$ROOT/backlog" b:sprint:join "Episode 1" "Count Dooku" 1 "$oldRepublic"
"$ROOT/backlog" b:sprint:join "Episode 1" "Jabba The Hutt" 1 "$oldRepublic"

"$ROOT/backlog" b:sprint:join "Episode 2" "Anakin Skywalker" 10 "$oldRepublic"
"$ROOT/backlog" b:sprint:join "Episode 2" "Mace Windu" 3 "$oldRepublic"
"$ROOT/backlog" b:sprint:join "Episode 2" "Yoda" 2 "$oldRepublic"
"$ROOT/backlog" b:sprint:join "Episode 2" "Count Dooku" 1 "$oldRepublic"
"$ROOT/backlog" b:sprint:join "Episode 2" "Bobba Fett" 2 "$oldRepublic"

"$ROOT/backlog" b:sprint:join "Episode 3" "Darth Vader" 1 "$oldRepublic"
"$ROOT/backlog" b:sprint:join "Episode 3" "Mace Windu" 6 "$oldRepublic"
"$ROOT/backlog" b:sprint:join "Episode 3" "Yoda" 4 "$oldRepublic"
"$ROOT/backlog" b:sprint:join "Episode 3" "Count Dooku" 2 "$oldRepublic"
"$ROOT/backlog" b:sprint:join "Episode 3" "Bobba Fett" 1 "$oldRepublic"

# New Order
"$ROOT/backlog" b:sprint:join "Episode 1" "Darth Vader" 9 "$newOrder"
"$ROOT/backlog" b:sprint:join "Episode 1" "Leia Organa" 8 "$newOrder"
"$ROOT/backlog" b:sprint:join "Episode 1" "Luke Skywalker" 8 "$newOrder"
"$ROOT/backlog" b:sprint:join "Episode 1" "TK-421" 1 "$newOrder"
"$ROOT/backlog" b:sprint:join "Episode 1" "Han Solo" 8 "$newOrder"

"$ROOT/backlog" b:sprint:join "Episode 2" "Darth Vader" 8 "$newOrder"
"$ROOT/backlog" b:sprint:join "Episode 2" "Leia Organa" 8 "$newOrder"
"$ROOT/backlog" b:sprint:join "Episode 2" "Luke Skywalker" 8 "$newOrder"
"$ROOT/backlog" b:sprint:join "Episode 2" "Yoda" 3 "$newOrder"
"$ROOT/backlog" b:sprint:join "Episode 2" "The Emperor" 1 "$newOrder"
"$ROOT/backlog" b:sprint:join "Episode 2" "Bobba Fett" 2 "$newOrder"
"$ROOT/backlog" b:sprint:join "Episode 2" "Han Solo" 8 "$newOrder"

"$ROOT/backlog" b:sprint:join "Episode 3" "Darth Vader" 9 "$newOrder"
"$ROOT/backlog" b:sprint:join "Episode 3" "Leia Organa" 8 "$newOrder"
"$ROOT/backlog" b:sprint:join "Episode 3" "Luke Skywalker" 8 "$newOrder"
"$ROOT/backlog" b:sprint:join "Episode 3" "Yoda" 3 "$newOrder"
"$ROOT/backlog" b:sprint:join "Episode 3" "The Emperor" 4 "$newOrder"
"$ROOT/backlog" b:sprint:join "Episode 3" "Bobba Fett" 2 "$newOrder"
"$ROOT/backlog" b:sprint:join "Episode 3" "Jabba The Hutt" 1 "$newOrder"
"$ROOT/backlog" b:sprint:join "Episode 3" "Han Solo" 8 "$newOrder"
