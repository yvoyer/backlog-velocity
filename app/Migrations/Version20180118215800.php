 ...
 */
class Version20180118215800 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__backlog_sprints AS SELECT id, name, estimated_velocity, actual_velocity, status, project_id, team_id, ended_at, started_at, created_at, current_focus FROM backlog_sprints');
        $this->addSql('DROP TABLE backlog_sprints');
        $this->addSql('CREATE TABLE backlog_sprints (id VARCHAR(255) NOT NULL COLLATE BINARY, name VARCHAR(255) NOT NULL COLLATE BINARY, actual_velocity INTEGER DEFAULT NULL, status VARCHAR(100) NOT NULL COLLATE BINARY, project_id VARCHAR(255) NOT NULL COLLATE BINARY, team_id VARCHAR(255) NOT NULL COLLATE BINARY, ended_at DATETIME DEFAULT NULL, started_at DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, current_focus INTEGER DEFAULT NULL, planned_velocity INTEGER DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO backlog_sprints (id, name, planned_velocity, actual_velocity, status, project_id, team_id, ended_at, started_at, created_at, current_focus) SELECT id, name, estimated_velocity, actual_velocity, status, project_id, team_id, ended_at, started_at, created_at, current_focus FROM __temp__backlog_sprints');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX unique_commitment_index ON backlog_commitments (sprint_id, member_id)');
        $this->addSql('DROP INDEX unique_sprint_index');
        $this->addSql('CREATE TEMPORARY TABLE __temp__backlog_sprints AS SELECT id, name, planned_velocity, actual_velocity, current_focus, status, project_id, team_id, created_at, started_at, ended_at FROM backlog_sprints');
        $this->addSql('DROP TABLE backlog_sprints');
        $this->addSql('CREATE TABLE backlog_sprints (id VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, actual_velocity INTEGER DEFAULT NULL, current_focus INTEGER DEFAULT NULL, status VARCHAR(100) NOT NULL, project_id VARCHAR(255) NOT NULL, team_id VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, started_at DATETIME DEFAULT NULL, ended_at DATETIME DEFAULT NULL, estimated_velocity INTEGER DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO backlog_sprints (id, name, estimated_velocity, actual_velocity, current_focus, status, project_id, team_id, created_at, started_at, ended_at) SELECT id, name, planned_velocity, actual_velocity, current_focus, status, project_id, team_id, created_at, started_at, ended_at FROM __temp__backlog_sprints');
        $this->addSql('DROP TABLE __temp__backlog_sprints');
        $this->addSql('CREATE UNIQUE INDEX unique_sprint_index ON backlog_sprints (name, project_id)');
        $this->addSql('DROP INDEX IDX_13602B65296CD8AE');
        $this->addSql('DROP INDEX UNIQ_13602B65296CD8AE7597D3FE');
