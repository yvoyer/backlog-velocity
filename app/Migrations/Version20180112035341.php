 ...
 */
class Version20180112035341 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE backlog_sprints ADD COLUMN estimated_focus INTEGER NOT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__backlog_sprints AS SELECT id, name, estimated_velocity, actual_velocity, current_focus, status, project_id, team_id, created_at, started_at, ended_at FROM backlog_sprints');
        $this->addSql('DROP TABLE backlog_sprints');
        $this->addSql('CREATE TABLE backlog_sprints (id VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, estimated_velocity INTEGER DEFAULT NULL, actual_velocity INTEGER DEFAULT NULL, current_focus INTEGER DEFAULT NULL, status VARCHAR(100) NOT NULL, project_id VARCHAR(255) NOT NULL, team_id VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, started_at DATETIME DEFAULT NULL, ended_at DATETIME DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO backlog_sprints (id, name, estimated_velocity, actual_velocity, current_focus, status, project_id, team_id, created_at, started_at, ended_at) SELECT id, name, estimated_velocity, actual_velocity, current_focus, status, project_id, team_id, created_at, started_at, ended_at FROM __temp__backlog_sprints');
