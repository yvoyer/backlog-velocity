...
Scenario: The Team has closed previous sprint
  ...
  # Sprint 1: 20 / 50 = .4
  And The sprint "Sprint 1" is closed with a total of 50 man days, an estimate of 35 SP, actual of 20 SP, focus of 40
  # Sprint 2: 40 / 50 = .8
  And The sprint "Sprint 2" is closed with a total of 50 man days, an estimate of 20 SP, actual of 40 SP, focus of 80
  # Sprint 3: 25 / 50 = .5
  And The sprint "Sprint 3" is closed with a total of 50 man days, an estimate of 40 SP, actual of 25 SP, focus of 50
  #  | name     | actual-focus | past-focus-avg        |
  #  | Sprint 1 | 20 / 50 = .4 | avg(.4) = .4          |
  #  | Sprint 2 | 40 / 50 = .8 | avg(.4, .8) = .6      |
  #  | Sprint 3 | 25 / 50 = .5 | avg(.4, .8, .5) = .57 |
  When The user "TK-421" is committed to the started sprint "Sprint 4" with 50 man days
  Then The sprint "Sprint 4" should have an estimated velocity of 28 story points
